object listSessionII {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(193); 

  	/********** #1 **********/
	/** Exam scores **/
	
	// Average of a student's scores
	...
	avg(List(80, 80, 80));System.out.println("""res1: Double = """ + $show(res$1));$skip(121); 
  ...
  avgAvg(List(List(93, 89, 90), List(75, 76, 68), List(88, 82, 78)));System.out.println("""res2: List[Double] = """ + $show(res$2));$skip(51); val res$3 = 
 	avgAvg(List(List(89, 95, 75), List(80, 80, 80)));System.out.println("""res3: List[Double] = """ + $show(res$3));$skip(300); 

	// List of positions in the list of passing exam scores (>= 70)
	...
	passing(List(List(60, 45, 75), List(80, 90, 100)));System.out.println("""res5: List[Int] = """ + $show(res$5));$skip(167); 

	// Sum of sum of all scores
	...
	sumSums(List(List(67, 83, 80), List(75, 82, 98), List(85, 82, 89)));System.out.println("""res7: Double = """ + $show(res$7));$skip(328); 
	
	/********** #2 **********/
	/** Finding all words in doc NOT in dictionary **/
	...
	spellCheck(List("eenie", "meenie", "miney", "mo"), List("meenie", "mo"));System.out.println("""res8: List[String] = """ + $show(res$8));$skip(244); 

	/********** #3 **********/
	/** Finding all words in doc NOT in dictionary (using map, filter, and/or reduce) **/
	...
	spellCheckFilter(List("eenie", "meenie", "miney", "mo"), List("meenie", "mo"));System.out.println("""res9: List[String] = """ + $show(res$9));$skip(338); 
	...
	// 3(5)^2 = 75
	evalMono((3.0, 2.0), 5.0);System.out.println("""res10: Double = """ + $show(res$10));$skip(177); 
