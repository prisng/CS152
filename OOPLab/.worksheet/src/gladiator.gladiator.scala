...
object gladiator {
	...
	};import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(2178); 
  ...
  // Singleton object
	...
	};System.out.println("""maximus  : gladiator.gladiator.CrusherMasher = """ + $show(maximus ));$skip(1091); 	// end of singleton object bee
